...
class Config
{
    ...
    /* Database */
    public $dbHost = 'localhost';                     // Altere para o nome do serviço do banco de dados
    public $dbUser = 'root';                               // Usuário do banco de dados
    public $dbPassword = 'admin';                      // Senha do banco de dados
    public $dbDatabase = 'leantime';                        // Nome do banco de dados
    public $dbPort = '3306';                                // Porta do banco de dados
    ...
    public $s3FolderName = '';                              // Foldername within S3 (can be empty)
